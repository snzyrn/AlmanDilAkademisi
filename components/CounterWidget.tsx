...
const CounterBlock = ({ num, labelKey }: CounterBlockProps) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-white md:px-8 md:pt-10 md:pb-8 my-2">
...
const CounterWidget = () => {
  ...
  return (
    <main className="relative flex lg:flex-row flex-col justify-center items-center bg-gray-50 overflow-hidden px-20">
