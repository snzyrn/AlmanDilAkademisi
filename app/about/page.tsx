  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-grow p-4">
        <div className="text-gray-500 text-lg 2xl:text-xl text-center mt-10 px-4 lg:px-24">
          <p>{t("aboutPage.description")}</p>
        </div>
        <div className="flex flex-col lg:flex-row items-center justify-center mt-28 mb-24 gap-5">
